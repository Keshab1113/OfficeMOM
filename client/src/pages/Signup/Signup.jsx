                    ...
                    <div className="pt-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          <div
                            className={`w-3 h-3 rounded-full ${currentStep >= 1 ? "bg-indigo-600" : "bg-gray-300"
                              }`}
                          ></div>
                          <span
                            className={`text-sm font-medium ${currentStep >= 1 ? "text-indigo-600" : "text-gray-500"
                              }`}
                          >
                            Account Details
                          </span>
                        ...
                        <div className="flex items-center space-x-2">
                          <div
                            className={`w-3 h-3 rounded-full ${currentStep >= 2 ? "bg-indigo-600" : "bg-gray-300"
                              }`}
                          ></div>
                          <span
                            className={`text-sm font-medium ${currentStep >= 2 ? "text-indigo-600" : "text-gray-500"
                              }`}
                          >
                            Verify Email
                          </span>
