  ...
  return (
    <section className="relative flex h-full min-h-screen w-full items-center justify-center dark:bg-[linear-gradient(90deg,#06080D_0%,#0D121C_100%)] bg-[linear-gradient(180deg,white_0%,#d3e4f0_100%)]">
      ...
      <div className="flex items-center justify-center relative z-20">
        ...
        >
          <p className="relative text-center z-20 dark:bg-gradient-to-b dark:from-neutral-200 dark:to-neutral-500 bg-gradient-to-br from-black to-blue-500 bg-clip-text text-3xl font-bold text-transparent md:text-4xl">
          ...
          <p className="mb-10 mt-1 text-lg text-center text-gray-700 font-bold">
            To access all features, you need to create an account first
          </p>
          <label
            htmlFor="name"
