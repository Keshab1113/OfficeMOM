...
const Home = () => {
  ...
  return (
    <section className="relative flex h-full min-h-screen w-full items-center justify-center bg-[linear-gradient(90deg,#06080D_0%,#0D121C_100%)]">
      <div
        className={cn(
          "absolute inset-0",
      ...
      />
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] bg-[linear-gradient(90deg,#06080D_0%,#0D121C_100%)]"></div>
      {heading === "" && (
        <div className=" flex flex-col justify-center items-center">
          <p className="relative text-center z-20 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text text-3xl font-bold text-transparent md:text-5xl">
            Welcome to Office<span className="text-blue-400">MoM</span>
          </p>
          <p className="mt-3 text-center relative z-20 bg-gradient-to-b from-white to-blue-500 bg-clip-text text-xl font-bold text-transparent md:text-xl">
            Automate Meeting Minutes Seamlessly
          </p>
          <p className="mt-20 relative max-w-[80%] text-center z-20 bg-gradient-to-b from-white to-blue-500 bg-clip-text text-xl font-bold text-transparent md:text-2xl">
      ...
      {heading==="Online Meeting Bot" && <TakeNotes/>}
